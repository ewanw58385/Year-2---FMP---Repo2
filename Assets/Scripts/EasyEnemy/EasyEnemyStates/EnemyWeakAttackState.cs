...
public class EnemyWeakAttackState : BaseState
{
    ...
    public override void UpdateLogic()
    {
        ...
        if (_EFSM.enemyAnim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.45f) //if attack animation is at the point of charging lightining 
        {
                ...
                _EFSM._combatAnim.Play("LightiningAnim"); //play lightining animation

            if (_EFSM._combatAnim.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.4f) //if lightining anim is at point of hitting player 
            {
    ...
    public override void Exit()
    {
        ...
        _EFSM._combatAnim.SetTrigger("lightiningStrike");
